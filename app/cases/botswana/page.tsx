...
import botswana from "@/data/cases/botswana";
...
const BotswanaCarousel = dynamic(() => import("@/components/case/BotswanaCarousel"), {
  ssr: false,
  loading: () => (
    ...
    <>
      ...
      <section className="px-6 py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <ScrollReveal direction="left">
            ...
            <CountryMap
              coordinates={botswana.coordinates}
              country={botswana.country}
            />
            <p className="text-xs text-text-muted mt-3 leading-relaxed">
              Botswana is landlocked in Southern Africa, bordered by South Africa, Zimbabwe, Zambia, and Namibia. Its Kalahari geography — semi-arid and resource-poor on the surface — concealed the kimberlite pipes that would transform its economy.
            </p>
          </ScrollReveal>
      ...
      <section className="px-6 pb-12 max-w-7xl mx-auto">
        <ScrollReveal>
          ...
          <CaseIndicators indicators={botswana.indicators} />
        </ScrollReveal>
      </section>
      ...
      <div className="border-t border-border/30 border-b border-border/30 bg-gradient-to-b from-ink-900/20 to-transparent">
        <CausalQuestion
          puzzle={botswana.puzzle}
          causalQuestion={botswana.causalQuestion}
          onReveal={() => setDiagramRevealed(true)}
          revealed={diagramRevealed}
          referencedTexts={[
            { title: "Why Nations Fail", slug: "why-nations-fail" },
            { title: "Political Order and Political Decay", slug: "political-order-and-political-decay" },
          ]}
        />
      </div>
          ...
          >
            <ScrollReveal>
              ...
              <p className="text-sm text-text-secondary mb-8 max-w-2xl">
                This diagram shows the causal chain from pre-colonial and structural factors through mechanisms to development outcomes. The dashed amber lines show shadow effects — costs and trade-offs.{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-start">
              <div>
                ...
                <CaseTimeline events={botswana.timeline} />
              </div>
              <CausalDiagram
                causalNodes={botswana.causalNodes}
                causalEdges={botswana.causalEdges}
      ...
      {diagramRevealed && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {botswana.operationalTakeaways.map((t, i) => (
      ...
      {/* ── Costs & Shortcomings ──────────────────────────── */}
      {botswana.costs && botswana.costs.length > 0 && (
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary max-w-2xl leading-relaxed">
                  Botswana is a strong case in resource management and democratic consolidation. It is not a case of inclusive growth or distributional equity. The gains documented above coexist with high inequality, diamond dependency, and the marginalization of indigenous San communities.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <div className="h-24 border-t border-border/30 mt-8 flex items-center justify-center px-6">
        <p className="text-xs text-text-muted text-center max-w-2xl">
          This analysis is pedagogical. Botswana's development experience is the subject of ongoing scholarly debate about the relative weight of institutions, leadership, and luck. The goal is analytical clarity about mechanisms, not a simple success narrative.
        </p>
      </div>
    </>
  );
