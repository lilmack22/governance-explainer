...
import sierraLeone from "@/data/cases/sierra-leone";
...
const SierraLeoneCarousel = dynamic(() => import("@/components/case/SierraLeoneCarousel"), {
  ssr: false,
  loading: () => (
...
export default function SierraLeonePage() {
  ...
  return (
    <>
      {/* ── Hero ──────────────────────────────────────────── */}
      <CaseHero caseStudy={sierraLeone} />
      ...
      <section className="px-6 py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <ScrollReveal direction="left">
            ...
            <CountryMap
              coordinates={sierraLeone.coordinates}
              country={sierraLeone.country}
            />
            <p className="text-xs text-text-muted mt-3 leading-relaxed">
              Sierra Leone sits on West Africa's Atlantic coast, bordered by Guinea to the north and east, and Liberia to the southeast — the country from which the RUF launched its insurgency with Charles Taylor's backing.
            </p>
          </ScrollReveal>
      ...
      <section className="px-6 pb-12 max-w-7xl mx-auto">
        <ScrollReveal>
          ...
          <CaseIndicators indicators={sierraLeone.indicators} />
        </ScrollReveal>
      </section>
      ...
      <div className="border-t border-border/30 border-b border-border/30 bg-gradient-to-b from-ink-900/20 to-transparent">
        <CausalQuestion
          puzzle={sierraLeone.puzzle}
          causalQuestion={sierraLeone.causalQuestion}
          ...
          >
            <ScrollReveal>
              ...
              <p className="text-sm text-text-secondary mb-8 max-w-2xl">
                This diagram shows the causal chain from structural conditions and regional dynamics through intervention mechanisms to post-war outcomes. The dashed amber lines show shadow effects — costs and implementation gaps.{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-start">
              <div>
                ...
                <CaseTimeline events={sierraLeone.timeline} />
              </div>
              <CausalDiagram
                causalNodes={sierraLeone.causalNodes}
                causalEdges={sierraLeone.causalEdges}
      ...
      {diagramRevealed && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {sierraLeone.operationalTakeaways.map((t, i) => (
      ...
      {/* ── Costs & Shortcomings ──────────────────────────── */}
      {sierraLeone.costs && sierraLeone.costs.length > 0 && (
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary max-w-2xl leading-relaxed">
                  Sierra Leone's post-war stabilization is real. It is not a development success or a justice success. The gains documented above coexist with persistent extreme poverty, inadequate war victim support, and structural conditions that have not fundamentally changed.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <div className="h-24 border-t border-border/30 mt-8 flex items-center justify-center px-6">
        <p className="text-xs text-text-muted text-center max-w-2xl">
          This analysis is pedagogical. Sierra Leone's post-war experience is the subject of ongoing research and debate. The goal is analytical clarity about what ended the war and what has built since — not a simple optimistic narrative.
        </p>
      </div>
    </>
  );
