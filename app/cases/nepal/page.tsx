...
import nepal from "@/data/cases/nepal";
...
const NepalCarousel = dynamic(() => import("@/components/case/NepalCarousel"), {
  ssr: false,
  loading: () => (
    ...
    <>
      ...
      <section className="px-6 py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <ScrollReveal direction="left">
            ...
            <CountryMap
              coordinates={nepal.coordinates}
              country={nepal.country}
            />
            <p className="text-xs text-text-muted mt-3 leading-relaxed">
              Nepal is landlocked between India to the south and China to the north — a geographic position that makes Indian diplomatic preferences structurally influential on Nepali politics, and that shaped the peace process significantly.
            </p>
          </ScrollReveal>
      ...
      <section className="px-6 pb-12 max-w-7xl mx-auto">
        <ScrollReveal>
          ...
          <CaseIndicators indicators={nepal.indicators} />
        </ScrollReveal>
      </section>
      ...
      <div className="border-t border-border/30 border-b border-border/30 bg-gradient-to-b from-ink-900/20 to-transparent">
        <CausalQuestion
          puzzle={nepal.puzzle}
          causalQuestion={nepal.causalQuestion}
          onReveal={() => setDiagramRevealed(true)}
          revealed={diagramRevealed}
          referencedTexts={[
            { title: "Political Order in Changing Societies", slug: "political-order-in-changing-societies" },
            { title: "Building State Capability", slug: "building-state-capability" },
          ]}
        />
      </div>
          ...
          >
            <ScrollReveal>
              ...
              <p className="text-sm text-text-secondary mb-8 max-w-2xl">
                This diagram shows the causal chain from structural grievances and political miscalculation through coalition mechanisms to constitutional outcomes. The dashed amber lines show shadow effects — persistent instability and unresolved tensions.{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-start">
              <div>
                ...
                <CaseTimeline events={nepal.timeline} />
              </div>
              <CausalDiagram
                causalNodes={nepal.causalNodes}
                causalEdges={nepal.causalEdges}
      ...
      {diagramRevealed && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {nepal.operationalTakeaways.map((t, i) => (
      ...
      {/* ── Costs & Shortcomings ──────────────────────────── */}
      {nepal.costs && nepal.costs.length > 0 && (
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary max-w-2xl leading-relaxed">
                  Nepal's constitutional transformation is real. It is not a development success or a stability success. The gains documented above coexist with chronic political instability, stalled transitional justice, and an economy that depends on outmigration rather than structural transformation.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <div className="h-24 border-t border-border/30 mt-8 flex items-center justify-center px-6">
        <p className="text-xs text-text-muted text-center max-w-2xl">
          This analysis is pedagogical. Nepal's peace process and constitutional transition are the subject of ongoing scholarly debate and political contestation. The goal is analytical clarity about causal mechanisms, not a definitive verdict on an unfinished process.
        </p>
      </div>
    </>
  );
